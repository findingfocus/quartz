...
Love2D itself is just functions it calls for you: `love.load` once, `love.update(dt)` every frame, `love.draw()` every frame. See [[04-Love2D-Basics/index\|Love2D Basics]].
...
> [!tip] Next step
> Continue with [[04-Love2D-Basics/index|Love2D Basics]] — the 3 functions that run every game.

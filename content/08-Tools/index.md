...
| [push.lua](https://github.com/Ulydev/push)        | Resolution scaling, from Ulysse Ramage                             | See [[07-Cookbook/Scaling-with-Push\|Scaling recipe]]              |
...
| [bitser](https://github.com/gvx/bitser) | Saving nested tables (inventories, unlock maps) | When `string.format` can't hold your save — see [[07-Cookbook/Save-and-Load\|Save & Load]] |
| [jumper](https://github.com/Yonaba/Jumper)        | Pathfinding                                                        | Grid-based enemies                                                 |

> [!WARNING]
> Library trap: installing 6 libraries before writing gameplay. Finish [[05-First-Game/index|Pong]] with zero libraries first — you'll know exactly which one you need next.

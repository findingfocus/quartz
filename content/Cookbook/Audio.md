...
Free sound sources: record with Audacity, generate with [jsfxr](https://sfxr.me/), music from [OpenGameArt](https://opengameart.org/) (check licenses). Full list in [[Tools/index\|Tools]].

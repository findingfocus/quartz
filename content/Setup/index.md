...
> [!TIP]
> Why Love2D? It's free, tiny, stable, and ships to Windows/Mac/Linux/Web/Steam from one codebase. I document the alternatives in [[Beyond/index\|Beyond Love2D]] if you're curious about Godot or 3D.
...
- **What I use:** Neovim + Git (see [[Tools/index\|Tools]] for my full setup)
...
Full annotated version with state machine lives in [[Starter-Template/index\|Starter Template]].
...
> [!tip] Next step
> Continue with [[Lua-Essentials/index|Lua Essentials]] (Path A) or [[Love2D-Basics/index|Love2D Basics]] (Path B). Or skip ahead and [[First-Game/index|build Pong]].
